...
export const CVNode = memo(function CVNode() {
  return (
    <a 
      ...
      className="group relative block px-6 md:px-8 py-5 md:py-6 rounded-[1.5rem] md:rounded-[2rem] bg-background md:bg-ui-primary/5 md:backdrop-blur-3xl border border-ui-primary/20 shadow-lg md:shadow-[0_20px_50px_-15px_var(--ui-primary)]/20 w-72 md:w-64 cursor-pointer hover:bg-ui-primary/10 transition-all duration-700 hover:-translate-y-2 overflow-hidden no-underline"
    >
      {/* Hover Light effect */}
