...
export function NotFoundNode() {
  return (
    <div className="relative p-1 rounded-[2.5rem] bg-linear-to-br from-red-500/20 to-transparent border border-red-500/10 shadow-[0_0_50px_rgba(239,68,68,0.1)] w-80 md:w-96 overflow-hidden">
      <Handle type="target" position={Position.Top} className="opacity-0" />
      <Handle type="source" position={Position.Bottom} className="opacity-0" />

      <section className="relative bg-background/80 backdrop-blur-3xl rounded-[2.3rem] p-8 text-center border border-white/5">
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm text-foreground/50 leading-relaxed font-medium mb-10 max-w-[80%] mx-auto">
            The node you&apos;re looking for was either de-indexed or moved to an encrypted sector.
          </p>
