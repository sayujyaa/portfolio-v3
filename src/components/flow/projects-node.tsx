...
export const ExperienceNode = memo(function ExperienceNode() {
  return (
    <main className="relative px-6 md:px-12 py-8 md:py-12 rounded-[2.5rem] md:rounded-[3.5rem] bg-background md:bg-background/40 md:backdrop-blur-3xl border border-foreground/10 shadow-xl md:shadow-2xl w-80 md:w-md transition-all duration-700 group overflow-hidden">
